...
const projectData = [
	...
	{ label: '사업위치', value: '경기도 평택시 브레인시티 일반산업단지 일원' },
	{ label: '대지면적', value: '추후 공개 예정' },
	{ label: '건축면적', value: '추후 공개 예정' },
	{ label: '연면적', value: '추후 공개 예정' },
	{ label: '용적률', value: '추후 공개 예정' },
	{ label: '건축규모', value: '최저 2층 ~ 최고 35층, 14개동' },
	{ label: '세대수', value: '총 1,600세대' },
];
...
const BusinessGuide1 = () => {
	...
	return (
		<div className={styles.container}>
			...
			<meta
				name="description"
				content="브레인시티 비스타동원 사업개요를 확인하세요. 단지 위치, 건축 규모, 주택형 등 주요 정보를 안내합니다."
			/>
			<meta
				name="keywords"
				content="브레인시티 비스타동원, 평택 브레인시티, 사업개요, 평택 분양, 브레인시티 아파트, 프리미엄 아파트"
			/>
			<link rel="canonical" href="https://www.sketchs.co.kr/BusinessGuide/intro" />
			...
			<meta property="og:url" content="https://www.sketchs.co.kr/BusinessGuide/intro" />
			...
			<meta name="twitter:url" content="https://www.sketchs.co.kr/BusinessGuide/intro" />
			...
			브레인시티 비스타동원의 사업개요 페이지입니다.
			단지 위치, 건축 규모, 주택형 등 주요 정보를 한눈에 확인하실 수 있습니다.
			</p>

			<div className={styles.textBox}>
			<div>미래가치를 품은 브레인시티 중심 입지</div>
			<div>브레인시티 비스타동원 사업개요 안내</div>
			</div>


			<img className={styles.img3} src={page1} alt="브레인시티 비스타동원 사업안내 이미지"/>
