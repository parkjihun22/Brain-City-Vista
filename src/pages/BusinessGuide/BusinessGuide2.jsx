...
const BusinessGuide2 = () => {
    ...
    return (
        <div className={styles.container}>
            ...
            <meta
                name="description"
                content="브레인시티 비스타동원 분양일정을 확인하세요. 모델하우스 오픈, 청약 접수, 당첨자 발표 등 주요 일정을 한눈에 안내합니다."
            />
            <meta
                name="keywords"
            ...
            <meta property="og:title" content="브레인시티 비스타동원 - 분양일정" />
            <meta
            ...
            <meta name="twitter:title" content="브레인시티 비스타동원 - 분양일정" />
            <meta
            ...
            <h1 className={styles.screenReaderOnly}>브레인시티 비스타동원 - 분양일정</h1>
            <p className={styles.screenReaderOnly}>
            브레인시티 비스타동원의 분양일정을 안내합니다.
            모델하우스 오픈 및 청약 진행 등 주요 일정을 확인하실 수 있습니다.
            </p>

            <div className={styles.textBox}>
            <div>한눈에 보는 분양 진행 일정</div>
            <div>브레인시티 비스타동원, 분양일정을 확인하세요.</div>
            </div>

            {/* ✅ 기존 이미지 부분 주석 처리하고 Ready 컴포넌트 표시 */}
            <img className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`} src={page1} alt="브레인시티 비스타동원분양일정안내-image1" />
