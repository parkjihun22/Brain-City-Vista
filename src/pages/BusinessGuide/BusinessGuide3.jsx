	...
	return (
		<div className={styles.container}>
			<Helmet>
				...
				{/* SEO 핵심 */}
				<title>브레인시티 비스타동원 - 공급안내</title>
				<meta
					name="description"
					content="브레인시티 비스타동원 공급안내를 확인하세요. 공급개요, 신청자격, 제출서류(필요 시), 유의사항 등 청약에 필요한 핵심 정보를 안내합니다."
				/>
				<meta
					name="keywords"
					content="브레인시티 비스타동원, 공급안내, 청약안내, 신청자격, 공급개요, 유의사항, 평택 브레인시티, 브레인시티 아파트"
				/>
				...
				<meta property="og:title" content="브레인시티 비스타동원 - 공급안내" />
				<meta
				...
				<meta name="twitter:title" content="브레인시티 비스타동원 - 공급안내" />
				<meta
			...
			<h1 className={styles.screenReaderOnly}>브레인시티 비스타동원 - 공급안내</h1>
			<p className={styles.screenReaderOnly}>
			브레인시티 비스타동원의 공급안내 페이지입니다.
			공급개요, 신청자격, 유의사항 등 청약 진행에 필요한 정보를 안내합니다.
			</p>

			<div className={styles.textBox}>
			<div>청약 전에 꼭 확인해야 할 핵심 정보</div>
			<div>브레인시티 비스타동원 공급안내</div>
			</div>

			{/* 이미지에 isImageVisible 상태 적용 */}
			<img className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`} src={page1} alt="브레인시티 비스타동원 계약서류안내-image1" />
