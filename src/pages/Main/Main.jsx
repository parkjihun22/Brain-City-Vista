      ...
      {!isMobile ? (
        ...
        <div className={styles.imageContainer}>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="브레인시티 비스타동원 브랜드소개-image4"
                />
                <div className={styles.text1}>브레인시티 비스타동원</div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://formspree.io/f/xwvwerbp"
              method="POST"
            >
              <label htmlFor="name">
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="브레인시티 비스타동원 오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.mainImageTextSub1}>
            ...
            새로운 주거 기준을 제시하는
            <br />
            <span className={styles.greyText1}>브레인시티 비스타동원</span>
          </div>
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 브레인시티 비스타동원에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="브레인시티 비스타동원 모바일 조감도 이미지"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="브레인시티 비스타동원 브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="브레인시티 비스타동원 오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
