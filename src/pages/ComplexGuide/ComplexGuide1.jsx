...
const ComplexGuide1 = () => {
	...
	return (
		...
		<Helmet>
			...
			<meta
				name="description"
				content="브레인시티 비스타동원 단지배치도를 확인하세요. 동별 위치와 주요 동선, 커뮤니티 및 조경 공간 배치를 한눈에 확인할 수 있도록 안내합니다."
			/>
			<meta
				name="keywords"
		...
		<h1 className={styles.screenReaderOnly}>브레인시티 비스타동원 - 단지배치도</h1>
		<p className={styles.screenReaderOnly}>
		단지배치도 페이지는 브레인시티 비스타동원의 단지 구성도를 제공합니다.
		동별 위치, 커뮤니티 시설, 조경 및 주요 동선을 시각적으로 확인할 수 있도록 안내합니다.
		</p>

		<div className={styles.textBox}>
		<div>한눈에 보는 단지 구성과 동선</div>
		<div>브레인시티 비스타동원 단지배치도</div>
		</div>
