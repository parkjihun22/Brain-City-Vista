...
const ComplexGuide1 = () => {
  ...
  return (
    ...
    <Helmet>
      ...
      <meta
        name="description"
        content="브레인시티 비스타동원 호수배치도를 통해 세대별 위치와 동·호수 배치 구조를 확인하세요."
      />
      <meta
        name="keywords"
        content="브레인시티 비스타동원, 호수배치도, 세대배치, 동호수 안내, 단지안내, 평택 브레인시티, 브레인시티 아파트"
      />
      ...
      <meta
        ...
        content="브레인시티 비스타동원 호수배치도에서 세대 위치와 배치 구조를 한눈에 확인하세요."
      />
      ...
      <meta property="og:image:alt" content="브레인시티 비스타동원 호수배치도" />

      {/* Twitter */}
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content="브레인시티 비스타동원 - 호수배치도" />
      <meta
        name="twitter:description"
        content="브레인시티 비스타동원 호수배치도를 통해 세대 위치와 동·호수 배치를 확인하세요."
      />
      <meta name="twitter:image" content="https://www.sketchs.co.kr/Main1.png" />
      <meta name="twitter:url" content="https://www.sketchs.co.kr/ComplexGuide/detailintro" />
    </Helmet>
