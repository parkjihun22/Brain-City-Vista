...
export default function Customer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://formspree.io/f/xwvwerbp", {
        method: "POST",
...
<>
      <Helmet>
        ...
        {/* Primary SEO */}
        <title>브레인시티 비스타동원– 관심고객 등록</title>
        <meta
          name="description"
          content="브레인시티 비스타동원관심고객 등록 페이지입니다. 분양 일정 및 주요 안내 소식을 빠르게 받아보고, 상담 요청을 남겨보세요."
        />
        <meta
          name="keywords"
          content="브레인시티 비스타동원, 관심고객 등록, 상담 신청, 분양 일정 알림, 방문 안내"
        />
        <link rel="canonical" href="https://www.sketchs.co.kr/Contact/interest" />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:locale" content="ko_KR" />
        <meta property="og:site_name" content="브레인시티 비스타동원" />
        <meta property="og:title" content="브레인시티 비스타동원– 관심고객 등록" />
        <meta
          property="og:description"
          content="분양 일정 및 주요 안내 소식을 빠르게 받아보세요. 간편한 관심고객 등록/상담 신청."
        />
        <meta property="og:url" content="https://www.sketchs.co.kr/Contact/interest" />
        ...
        <meta name="twitter:title" content="브레인시티 비스타동원– 관심고객 등록" />
        <meta
          name="twitter:description"
          content="분양 일정 알림과 상담 요청을 간편하게 남겨보세요."
        />
        <meta name="twitter:image" content="https://www.sketchs.co.kr/Main1.png" />
        <meta name="twitter:url" content="https://www.sketchs.co.kr/Contact/interest" />
        ...
        <script type="application/ld+json">
          {`{
            ...
            "url": "https://www.sketchs.co.kr/Contact/interest",
            "inLanguage": "ko-KR",
            ...
            "breadcrumb": {
              ...
              "itemListElement": [{
                ...
                "position": 1,
                "name": "홈",
                "item": "https://www.sketchs.co.kr/"
              }, {
                "@type": "ListItem",
                "position": 2,
                "name": "관심고객 등록",
                "item": "https://www.sketchs.co.kr/Contact/interest"
              }]
            },
            "potentialAction": {
              "@type": "SubmitAction",
              "target": "https://www.sketchs.co.kr/Contact/interest",
              "name": "관심고객 등록 제출"
            }
          }`}
        </script>
      ...
      <div className={styles.customerWrap}>
        ...
        <div className={styles.customerLeft}>
          <div className={styles.textBlock}>
            <h2 className={styles.projectName}>브레인시티 비스타동원</h2>
