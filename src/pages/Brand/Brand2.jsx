	...
	return (
		<div className={styles.container}>
			<Helmet>
				...
				{/* Minimal SEO (Subpage) */}
				<title>브레인시티 비스타동원 - 홍보영상</title>
				<meta
					name="description"
					content="브레인시티 비스타동원 홍보영상으로 단지의 분위기와 핵심 프리미엄을 빠르게 확인하세요."
				/>
				<meta
					name="keywords"
				...
				<meta property="og:title" content="브레인시티 비스타동원 - 홍보영상" />
				<meta
				...
				<meta name="twitter:title" content="브레인시티 비스타동원 - 홍보영상" />
				<meta
			...
			<h1 className={styles.screenReaderOnly}>브레인시티 비스타동원 - 홍보영상</h1>
			<p className={styles.screenReaderOnly}>
			브레인시티 비스타동원의 홍보영상을 통해 단지의 분위기와 주요 특장점을 확인해보세요.
			단지 설계와 커뮤니티, 생활 인프라 등 핵심 포인트를 영상으로 빠르게 안내합니다.
			</p>

			<div className={`${styles.textBox} ${isTextVisible ? styles.active : ''}`}>
				<div>영상으로 먼저 만나는 단지의 분위기</div>
				<div>브레인시티 비스타동원의 핵심 가치를 확인하세요.</div>
			</div>
