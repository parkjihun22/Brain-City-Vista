...
const ComplexGuide1 = () => {
  const menuContents = [
    ...
    { title: "주택취득자금조달 작성안내", url: "/SalesInfo/guide" },
  ];
  ...
  return (
    <div className={styles.container}>
      ...
      <h1 className={styles.screenReaderOnly}>
        브레인시티 비스타동원- 주택취득자금조달 작성안내
      </h1>
      <p className={styles.screenReaderOnly}>
        브레인시티 비스타동원의 인터넷 청약은 간편하고 빠르게 분양에 참여할
        수 있는 방법을 제공합니다. 온라인을 통해 청약 절차를 빠르게 진행하며,
        언제 어디서든 쉽게 신청 가능합니다. 청약 전 반드시 필요한 정보와 절차를
        확인하고, 청약을 통해 브레인시티 비스타동원의 기회를 놓치지 마세요.
      </p>

      <div className={styles.textBox}>
        <div>주택취득자금조달 작성안내을 확인하세요</div>
        <div>소수만 누리는 프리미엄 브레인시티 비스타동원</div>
      </div>
      ...
      <img
        ...
        src={page1}
        alt="브레인시티 비스타동원주택취득자금조달 작성안내 이미지1"
