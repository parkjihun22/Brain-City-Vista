  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화 */}
        <title>브레인시티 비스타동원– 84A 평면안내</title>
        <meta
          name="description"
          content="브레인시티 비스타동원84A 평면안내입니다. 세대 구조, 공간 활용, 수납과 동선 구성을 확인하고 라이프스타일에 맞는 타입을 선택하세요."
        />
        <meta
          name="keywords"
          content="브레인시티 비스타동원, 84A, 평면안내, 평면도, 84타입, 세대구조, 공간활용"
        />
        <link rel="canonical" href="https://www.sketchs.co.kr/FloorPlan/84A" />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:locale" content="ko_KR" />
        <meta property="og:site_name" content="브레인시티 비스타동원" />
        <meta property="og:title" content="브레인시티 비스타동원– 84A 평면안내" />
        <meta
        ...
        <meta property="og:url" content="https://www.sketchs.co.kr/FloorPlan/84A" />

        {/* Twitter 카드 */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="브레인시티 비스타동원– 84A 평면안내" />
        <meta
          name="twitter:description"
          content="브레인시티 비스타동원84A 평면안내 – 구조/동선/수납 포인트를 확인하세요."
        />
        <meta name="twitter:image" content="https://www.sketchs.co.kr/Main1.png" />
        <meta name="twitter:url" content="https://www.sketchs.co.kr/FloorPlan/84A" />
        ...
        <script type="application/ld+json">
          {`{
            ...
            "url": "https://www.sketchs.co.kr/FloorPlan/84A",
            "inLanguage": "ko-KR"
          }`}
        </script>
      </Helmet>
      ...
      <p className={styles.screenReaderOnly}>
        브레인시티 비스타동원 평면안내 페이지입니다.
        세대 구조와 공간 활용 포인트를 확인하고, 59/84A/84B/84C 타입 중
      ...
      <img
        ...
        src={page1}
        alt="브레인시티 비스타동원84A 타입 평면안내 이미지"
